...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/lindajensen/devacademy-v2.git
   cd devacademy-v2
   ```
...
Both the backend and frontend will start on their respective ports, allowing you to develop and test the full application locally.
